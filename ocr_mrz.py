...
from ocr_backends.paddle_backend import (
    ...
    paddle_ocr_image as paddle_backend_ocr_image,
...
from ocr_backends.tesseract_backend import (
    ...
    ocr_image as tesseract_backend_ocr_image,
...
def _resolve_paddle_use_gpu() -> bool:
    return paddle_backend_resolve_use_gpu(PADDLEOCR_USE_GPU)


def _get_paddle_ocr():
    return paddle_backend_get_ocr(PADDLEOCR_LANG, PADDLEOCR_USE_GPU)
