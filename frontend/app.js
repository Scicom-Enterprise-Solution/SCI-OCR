...
const ZOOM_MIN = 0.85;
const ZOOM_MAX = 2.4;
const MRZ_GUIDE_HEIGHT_RATIO = 0.18;
const MRZ_GUIDE_WIDTH_RATIO = 0.92;
const MRZ_GUIDE_BOTTOM_MARGIN_RATIO = 0.04;
const ROTATE_DRAG_SENSITIVITY = 0.024;
const QUALITY_SAMPLE_MAX_WIDTH = 180;
const QUALITY_LOW_CONTRAST_STDDEV = 28;
const QUALITY_LOW_EDGE_STRENGTH = 15;
...
function buildQualityCard() {
  ...
  return {
    title: "Input Quality",
    items: warnings.length > 0 ? warnings : [
